        ...
        try:
            ...
            if http_x_hub_signature:
                ...
                if "MC-2" == str(repo_name) and http_x_github_event == 'push':
                    ...
                    os.system("cd /src && git pull origin master -f && chmod +x dev_start.sh && docker restart djangoIRC")
                    # refresh DNS
                    os.system("cd /src/machine/IRCmachinedocker && python3 code/aliyun.py")
