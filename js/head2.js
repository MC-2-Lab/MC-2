...
document.writeln("    <a>DATABASES&amp;CODES</a>");
document.writeln("							</div>");
document.writeln("							<div style=\'width:250px;\' class=\'list_children\'>");
document.writeln("									<a href = \'../html/Databases_Codes_Perception.html\'>Video or Image Perception</a>");
document.writeln("								<br/>");
document.writeln("									<a href = \'../html/Databases_Codes_Compression.html\'>Video Compression</a>");
document.writeln("								<br/>");
document.writeln("									<a href = \'../html/Databases_Codes_VAR.html\'>Virtual/Augmented Reality</a>");
document.writeln("								<br/>");
document.writeln("									<a href = \'../html/Databases_Codes_Communication.html\'>Multimedia Communication</a>");
