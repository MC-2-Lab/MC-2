...
function get_page(){
    //使用全局变量 temp_page
    var params = {"mode":"0","page":temp_page,"ini_name":"data_codes_compression"};
...
function get_search(){
    //使用全局变量 temp_page
    var params = {"mode":"1","context":document.getElementById('input1').value,"ini_name":"data_codes_compression"};
    $.get('/api/', params, function(data){
        console.log(data);
        $('#show_news').empty();
        $('#show_news').append(data['data']);
